        ...
        <div className="container">
          <div className="row flex justify-between px-[56px] pt-[42px] pb-[58px]">
            <div className="text w-[620px]">
              <h2 className='mt-4 mb-6 text-xl font-semibold font-epilogue text-brand-color leading-[30px]'>Branding | Image making </h2>
              <h1 className='text-[68px] font-semibold font-epilogue text-brand-color'>Visual Designer</h1>
